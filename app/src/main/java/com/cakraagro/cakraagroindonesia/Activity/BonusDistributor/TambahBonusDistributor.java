...
public class TambahBonusDistributor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tambah_bonus_distributor);
            ...
            public void onClick(View view) {
                ...
                if (!Tanggal.isEmpty() && !TotalPenjualan.isEmpty() && !BonusPenjualan.isEmpty() && !BonusTahunan.isEmpty() && !NomorInvoice.isEmpty()){
                    if (selectedImageUri != null){
                        ...
                        Toast.makeText(TambahBonusDistributor.this, "Pilih Foto Terlebih Dahulu", Toast.LENGTH_SHORT).show();
                    }
                }else {
                    Toast.makeText(TambahBonusDistributor.this, "Semua Field Harus Di Isi", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void spinnerDistributor(){
        ...
        Spinner.enqueue(new Callback<ModelDistributor>() {
            ...
            public void onResponse(Call<ModelDistributor> call, Response<ModelDistributor> response) {
                ...
                spinnerAdapter= new ArrayAdapter<>(TambahBonusDistributor.this, android.R.layout.simple_spinner_item, namaDistributor);
...
//
    ...
    private void tambahData(File imagePath,String STanggal,String STotalPenjualan, String SBonusPenjualan, String SBonusTahunan,String SNomorInvoice) {
        try {
            ...
            Call<ModelBonus> simpan = interfaceBonus.setBonus(Foto,kodeMg,kodeSc,kodeDt,namaDt,Totalpenjualan,Bonuspenjualan,Bonustahunan,namaSc,Tgl,Nomorinvoice);
            simpan.enqueue(new Callback<ModelBonus>() {
                @Override
                public void onResponse(Call<ModelBonus> call, Response<ModelBonus> response) {
                    setNofitikasi(STanggal,namaSecretaryTerpilih,"notif","baru","baru","bonus","",kodeManagerTerpilih,"Mengirim Bonus Baru","Mengirim Bonus Baru","tidak");
                    Toast.makeText(TambahBonusDistributor.this, "Data Berhasil Disimpan", Toast.LENGTH_SHORT).show();
                    finish();
                }
                @Override
                public void onFailure(Call<ModelBonus> call, Throwable t) {
                    Toast.makeText(TambahBonusDistributor.this, "Data Gagal Disimpan", Toast.LENGTH_SHORT).show();
                }
            });
        }catch (IOException e){
            e.printStackTrace();

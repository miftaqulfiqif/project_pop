...
public class UbahDistributor extends AppCompatActivity {
    private String varId,varNama,varUsername,varPassword,varLevel,varKodesc,varNamasv,varTFoto,varFoto,varKodemg,varPerusahaan;
    ...
    private String NamaDistributor, Perusahaan, Username, Password;

    private String namaSecretaryTerpilih, kodeSecretaryTerpilih, kodeManagerTerpilih, level;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ubah_distributor);
        ...
        varLevel = getIntent().getStringExtra("xLevel");
        ...
        namadistributor.setText(varNama);
        perusahaan.setText(varPerusahaan);
        usernamedistributor.setText(varUsername);
        passworddistributor.setText(varPassword);
...
//        getLastId();
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!NamaDistributor.isEmpty() && !Perusahaan.isEmpty() && !Username.isEmpty() && !Password.isEmpty()){
                    ...
                    Toast.makeText(UbahDistributor.this, "Semua field harus diisi", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void updateData(){
        ...
        Call<ModelDistributor> updateDt = interfaceDistributor.update(varId,NamaDistributor,Username,Password,level,kodeSecretaryTerpilih,namaSecretaryTerpilih,Perusahaan,kodeManagerTerpilih);
        updateDt.enqueue(new Callback<ModelDistributor>() {
            @Override
            public void onResponse(Call<ModelDistributor> call, Response<ModelDistributor> response) {
                Toast.makeText(UbahDistributor.this, "Data Berhasil Di Update", Toast.LENGTH_SHORT).show();
                finish();
            }

            @Override
            public void onFailure(Call<ModelDistributor> call, Throwable t) {
                Toast.makeText(UbahDistributor.this, "Data Gagal Di Update", Toast.LENGTH_SHORT).show();
            }
        });
    }
    private void getLastId() {
        InterfaceDistributor interfaceDistributor = RetroServer.KonesiAPI(UbahDistributor.this).create(InterfaceDistributor.class);
        ...
        newid.enqueue(new Callback<ModelDistributor>() {
            ...
            public void onResponse(Call<ModelDistributor> call, Response<ModelDistributor> response) {
                ...
                String lastId = new DataDistributor(UbahDistributor.this, id).getLastId();
...
//                newId = "DT" + String.format("%03d", newNumber);
    ...
    private void spinnerSecretary() {
        ...
        Spinner.enqueue(new Callback<ModelSecretary>() {
            ...
            public void onResponse(Call<ModelSecretary> call, Response<ModelSecretary> response) {
                ...
                spinnerAdapter = new ArrayAdapter<>(UbahDistributor.this, android.R.layout.simple_spinner_item, namaSecretary);
    ...
    private void tambahData( File imagePath,String SNamaDistributor, String SUsername, String SPassword, String Slevel, String SkodeSecretaryTerpilih, String SnamaSecretaryTerpilih, String SkodeManagerTerpilih, String SPerusahaan) {
        try {
            ...
            InterfaceDistributor interfaceDistributor = RetroServer.getRetroAPI(jwtToken,Level).create(InterfaceDistributor.class);
            Call<ModelDistributor> simpan = interfaceDistributor.updateDistributor(varId,Foto,Nama,Username,Password,Lvl,KodeSC,NamaSC,Perusahaan,KodeMG);
            simpan.enqueue(new Callback<ModelDistributor>() {
                @Override
                public void onResponse(Call<ModelDistributor> call, Response<ModelDistributor> response) {
                    Toast.makeText(UbahDistributor.this, "Data Berhasil Disimpan", Toast.LENGTH_SHORT).show();
                    finish();
                }

                @Override
                public void onFailure(Call<ModelDistributor> call, Throwable t) {
                    Toast.makeText(UbahDistributor.this, "Data Gagal Disimpan", Toast.LENGTH_SHORT).show();
                }
            });
        }catch (IOException e){
            e.printStackTrace();

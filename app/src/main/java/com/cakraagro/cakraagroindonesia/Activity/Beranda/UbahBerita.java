...
public class UbahBerita extends AppCompatActivity {

    private int varId;
    private String varJudul, varDeskripsi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        judulBerita.setText(varJudul);
        isiBerita.setText(varDeskripsi);
    ...
    private void tambahData(){
        ...
        Call<ModelBerita> simpan = interfaceBerita.updateBerita(varId,judul,isi);
        simpan.enqueue(new Callback<ModelBerita>() {
            @Override
            public void onResponse(Call<ModelBerita> call, Response<ModelBerita> response) {
                Toast.makeText(UbahBerita.this, "Berhasil Simpan Data", Toast.LENGTH_SHORT).show();
                finish();
            }

            @Override
            public void onFailure(Call<ModelBerita> call, Throwable t) {
                Toast.makeText(UbahBerita.this, "Gagal Simpan Data", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
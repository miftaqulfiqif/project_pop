...
public class TambahPaketProduk extends AppCompatActivity {
    EditText namapaket, tanaman, deskripsipaketproduk, hasil;
    TextView uploadppt,btntambah;
    String Ppt, Nama,Tanaman,Deskripsi,Hasil;
            ...
            public void onClick(View view) {
                ...
                if (!Nama.isEmpty() && !Tanaman.isEmpty() && !Deskripsi.isEmpty() && !Hasil.isEmpty()) {
                    if (pptUri != null) {
                        ...
                        Toast.makeText(TambahPaketProduk.this, "Pilih PPT terlebih dahulu", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(TambahPaketProduk.this, "Semua field harus diisi", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
        ...
        if (requestCode == REQUEST_PICK_PPT_FILE && resultCode == RESULT_OK && data != null) {
            ...
            if (pptUri != null) {
                // Ubah URI menjadi File
                 Toast.makeText(TambahPaketProduk.this, "Berhasil Memilih PPT", Toast.LENGTH_SHORT).show();
            }else {
                Toast.makeText(TambahPaketProduk.this, "Gagal Memilih PPT", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void uploadData(File pptFile, String Snama,String Stanaman,String Sdeskripsi,String Shasil){
        ...
        try {
            ...
            Call<ModelPaketProduk> tambah = interfacePaketProduk.setPaketProduk(Ppt,tanaman,paket_produk,iterasi,hasil);
            tambah.enqueue(new Callback<ModelPaketProduk>() {
                ...
                public void onResponse(Call<ModelPaketProduk> call, Response<ModelPaketProduk> response) {
                    Toast.makeText(TambahPaketProduk.this, "Berhasil Simpan Data", Toast.LENGTH_SHORT).show();
                    finish();
                }

                @Override
                public void onFailure(Call<ModelPaketProduk> call, Throwable t) {
                    Toast.makeText(TambahPaketProduk.this, "Gagal Simpan Data", Toast.LENGTH_SHORT).show();
                }
            });

        } catch (IOException e) {
                e.printStackTrace();
                Toast.makeText(TambahPaketProduk.this, "Gagal membaca file", Toast.LENGTH_SHORT).show();
        }
    }
}
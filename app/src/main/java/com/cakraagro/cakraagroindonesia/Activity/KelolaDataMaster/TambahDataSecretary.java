...
public class TambahDataSecretary extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tambah_data_secretary);
        ...
        call.enqueue(new Callback<ModelManager>() {
            ...
            public void onResponse(Call<ModelManager> call, Response<ModelManager> response) {
                ...
                spinnerAdapter = new ArrayAdapter<>(TambahDataSecretary.this, android.R.layout.simple_spinner_item, namaManager);
            ...
            public void onClick(View view) {
                ...
                if (!nama.isEmpty() && !username.isEmpty() && !password.isEmpty()) {
                    if (selectedImageUri != null){
                        ...
                        Toast.makeText(TambahDataSecretary.this, "Pilih Foto terlebih dahulu", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(TambahDataSecretary.this, "Semua field harus diisi", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
...
//            tampilfoto.setImageURI(selectedImageUri);
    ...
    private void tambahData(File imagePath, String Snama,String Susername,String Spassword, String SnamaManagerTerpilih, String SkodeManagerTerpilih,String Slevel) {
        try {
            ...
            Call<ModelSecretary> simpan = interfaceSimpan.setSecretary(Foto,Nama,Username,Password,Lvl,KDmanager,NamaManager);
            simpan.enqueue(new Callback<ModelSecretary>() {
                ...
                public void onResponse(Call<ModelSecretary> call, Response<ModelSecretary> response) {
                    Toast.makeText(TambahDataSecretary.this, "Data Berhasil Disimpan", Toast.LENGTH_SHORT).show();
                    finish();
                }

                @Override
                public void onFailure(Call<ModelSecretary> call, Throwable t) {
                    Toast.makeText(TambahDataSecretary.this, "Data Gagal Disimpan", Toast.LENGTH_SHORT).show();
                }
            });
        }catch (IOException e){
            e.printStackTrace();

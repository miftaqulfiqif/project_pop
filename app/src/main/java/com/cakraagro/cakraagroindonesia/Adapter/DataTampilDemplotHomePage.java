...
public class DataTampilDemplotHomePage extends RecyclerView.Adapter<DataTampilDemplotHomePage.HolderData>{
    private Context context;
    private ArrayList<ModelReport.report> listData;
    private int limit = 5;

    public DataTampilDemplotHomePage(Context context, ArrayList<ModelReport.report> listData) {
    ...
    public HolderData onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_demplothomepage,parent,false);
